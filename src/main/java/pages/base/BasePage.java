...
public class BasePage {
    ...
    private final By mainLogoButton = By.xpath("//a[@class='PJjFFWfVp']");
    ...
    public BasePage moveToLocation () {
        By scrollTo = By.xpath("(//div[@class='uT2qS5ASV yKzPSCu js-animate is-animated'])[2]");
    ...
    public BasePage locationButtonClick(int numButton) {
        moveToLocation();
        waitOneSeconds();
        By locationButton = By.xpath("(//a[@class='IjN1fcX'])[" + numButton + "]");
    ...
    public BasePage footerButtonClick(int numButton) {
        By footerButton = By.xpath("(//a[@class='cPsE2P2W'])[" + numButton + "]");
